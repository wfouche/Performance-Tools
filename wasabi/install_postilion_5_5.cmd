...
REM
start /b /wait /belownormal c:\Python27\python.exe install_postilion.py --install --config_file=install_postilion_5_5.py --media_path=x:\MosaicReleases --svc_domain="." --svc_account="Administrator" --svc_password="password"
